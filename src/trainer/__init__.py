...
from trainer.unlearn.continual import ContinualUnlearnTrainer, ContinualGradDiff
...
_register_trainer(ContinualUnlearnTrainer)
_register_trainer(ContinualGradDiff)
